...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bonusPoints: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>
    ...
    > &
      Schema.Attribute.Required
    cardNumber: Schema.Attribute.String & Schema.Attribute.Private
    ...
    firstCall: Schema.Attribute.DateTime
    gameDateTime: Schema.Attribute.DateTime & Schema.Attribute.Required
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::booking.booking"
    ...
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private
    usePoints: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>
  }
}
...
export interface ApiCarouselItemCarouselItem
  ...
  info: {
    displayName: "\u041A\u0430\u0440\u0443\u0441\u0435\u043B\u044C \u043D\u0430 \u0433\u043B\u0430\u0432\u043D\u043E\u0439"
...
export interface ApiCertificateCertificate extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Configure available certificate values"
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    baseQuestPrice: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0
    ...
    > &
      Schema.Attribute.Private
    notifyAboutBookingsEmail: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"test@mail.ru">
    phone: Schema.Attribute.String & Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
    social: Schema.Attribute.Component<"social.soczialnye-seti", false>
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private
  }
